...
<div className="container fluid  pt-8">
      ...
      <h1 align="center" font-color="white">SKIN THERAPY SERVICES</h1>
      < div>
       <ul id="top-nav">
                  <li>
                  ...
                  <li>
                  < Link className="active" to ="/waxing">Waxing</Link>
                  </li>
                  <li>
        ...
        {data.map((item)=>{
        item.recipients=1;
        if(item.category_id==="SkinTherapy"){ return(
